package com.icl.nphi.ui.patients.custom.afp
...
import com.icl.nphi.databinding.FragmentAfpFollowUpBinding
...
import com.icl.nphi.ui.patients.AddCaseActivity
 ...
 * Use the [AFPFollowUpFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AFPFollowUpFragment : Fragment() {
    ...
    private var _binding: FragmentAfpFollowUpBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAfpFollowUpBinding.inflate(inflater, container, false)
...
//                adapter.submitList(it)
    ...
    fun parseFromAssets(context: Context): List<OutputGroup> {
        ...
        try {
            val jsonContent = context.assets.open("afp-sixty-days.json")
                .bufferedReader()
                .use { it.readText() }
    ...
    companion object {
         ...
         * @return A new instance of fragment AFPFollowUpFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AFPFollowUpFragment().apply {
