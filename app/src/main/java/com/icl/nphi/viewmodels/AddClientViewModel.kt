...
import com.icl.nphi.models.SpecimenConfig
import com.icl.nphi.utils.Constants.ALL_LINK_IDS
import com.icl.nphi.utils.Constants.ALL_MPOX_LINK_IDS
import com.icl.nphi.utils.Constants.WEEK_ENDING_DATE
                ...
                try {
                    ...
                    extractedAnswers.forEach {
                        ...
                        if (it.linkId == WEEK_ENDING_DATE) {
                            val date =
                                SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).parse(it.answer)
                            if (date != null) {
                                measure.date = date
                            }
